...
module.exports = (data, callback) => {
  const transporter = nodemailer.createTransport({
    ...
    secure: false,
    auth: {
      user: "countdown.rbk@gmail.com",
      pass: "rbkcountdown"
    }
  }); 
  const mailOptions = {
    from: `"The CountDown Team", "countdown.rbk@gmail.com"`,
    to: `<${data.email}>`,
    subject: `Congratulations, ${data.username}! Here is you new product!`,
                         ...
                         <tr>
                            <td align="left" valign="top">
                               ...
                               <a href="#" target="_blank" style="display: block; max-width: 128px;">
                                  <img src="https://scontent.ftun10-1.fna.fbcdn.net/v/t1.15752-9/s2048x2048/83331090_511476979501471_9117774197093826560_n.png?_nc_cat=103&_nc_ohc=pV1SFCk715YAX_pOzfT&_nc_ht=scontent.ftun10-1.fna&oh=ce8f1d28be823f174aac3daa2c0bef40&oe=5ED7F3A1" alt="img" width="128" border="0" style="display: block; width: 128px;" />
                               </a>
                         ...
                         <tr>
                            <td align="left" valign="top">
                               <font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">
                                  <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">Hey ${data.username},</span>
                               </font>
                               <div style="height: 33px; line-height: 33px; font-size: 31px;">&nbsp;</div>
                               <font face="'Source Sans Pro', sans-serif" color="#585858" style="font-size: 24px; line-height: 32px;">
                                  <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 24px; line-height: 32px;">The CountDown team is sending you this email because you just won an auction! Congratulations on your new product, we hope you like it!</span>
                               </font>
                               <div style="height: 20px; line-height: 20px; font-size: 18px;">&nbsp;</div>
                               <font face="'Source Sans Pro', sans-serif" color="#585858" style="font-size: 24px; line-height: 32px;">
                                  <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 24px; line-height: 32px;">To claim your product, just log into your account and click on “My products.”</span>
                               </font>
                               <div style="height: 33px; line-height: 33px; font-size: 31px;">&nbsp;</div>
                               <table class="mob_btn" cellpadding="0" cellspacing="0" border="0" style="background: #27cbcc; border-radius: 4px;">
                                  <tr>
                                     <td align="center" valign="top"> 
                                        <a href="http://localhost:4200/account" target="_blank" style="display: block; border: 1px solid #27cbcc; border-radius: 4px; padding: 12px 23px; font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">
                                           <font face="'Source Sans Pro', sans-serif" color="#ffffff" style="font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">
                                              <span style="font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">Visit your account!</span>
                                           </font>
                                        </a>
                                     </td>
                                  </tr>
                                     ...
                                     <tr>
                                        ...
                                        <td class="mob_center" align="left" valign="top">
                                           ...
                                           <font face="'Source Sans Pro', sans-serif" color="#000000" style="font-size: 19px; line-height: 23px; font-weight: 600;">
                                              <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 19px; line-height: 23px; font-weight: 600;">Heni, Ali and Abdessalam</span>
                                           </font>
                                     ...
                                     <tr>
                                        <td align="center" valign="top">
                                           ...
                                           <div style="display: block; max-width: 177px;">
                                              <img src="https://scontent.ftun10-1.fna.fbcdn.net/v/t1.15752-9/s2048x2048/83331090_511476979501471_9117774197093826560_n.png?_nc_cat=103&_nc_ohc=pV1SFCk715YAX_pOzfT&_nc_ht=scontent.ftun10-1.fna&oh=ce8f1d28be823f174aac3daa2c0bef40&oe=5ED7F3A1" alt="img" width="177" border="0" style="display: block; width: 177px; max-width: 100%;" />
                                           </div>
                                        </td>
                                     </tr>
                                  </table>
